...
import { uploadFile, getUserFiles, downloadFile, previewFile, renameFile, moveFile, deleteFile, restoreFile, getTrash, replaceFile, deletePermanently, emptyTrash } from '../controllers/file.controller.js';
 ...
 *       - cookieAuth: []
 */
// Alias pour les stats (compatibilité mobile)
...
// Prévisualisation de fichier (images, PDF, vidéos)
